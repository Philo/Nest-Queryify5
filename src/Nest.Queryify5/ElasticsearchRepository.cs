...
namespace Nest.Queryify
{
    ...
    public partial class ElasticsearchRepository : IElasticsearchRepository
    {
        ...
        {
            return index ?? client.ConnectionSettings.DefaultIndex;
        }
        ...
        public BulkAllObservable<T> BulkAll<T>(IEnumerable<T> documents, string index = null, bool? refreshOnSave = null) where T : class
        {
